        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">global.Job</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexJob'}">global.Job</router-link></li>
                                    ...
                                    <form @submit.prevent="editJob" class="needs-validation">
                                        <div class="form-row row">
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom01">global.NameEn</label>
...
<!--                                                    <span v-if="v$.en.name.required.$invalid">global.NameEnIsRequired<br /> </span>-->
...
<!--                                                    <span v-if="v$.en.name.maxLength.$invalid">{{$t('global.NameEnIsMustHaveAtMost')}} {{ v$.en.name.maxLength.$params.max }} {{$t('global.Letters')}} </span>-->
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">global.NameAr</label>
                                                <input type="text"
                                                       class="form-control"
...
<!--                                                    <span v-if="v$.ar.name.maxLength.$invalid">{{$t('global.NameArIsMustHaveAtMost')}} {{ v$.ar.name.maxLength.$params.max }} {{$t('global.Letters')}} </span>-->
                                        ...
                                        <button class="btn btn-primary" type="submit">global.Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        editJob(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/job/${this.id}`,this.data)
                    .then((res) => {
                        notify({
                            title: `global.EditSuccessfully <i class="fas fa-check-circle"></i>`,
                            type: "success",
                            duration: 5000,
                            speed: 2000
                        });
